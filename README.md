...
This is a sample template for IntegrationTypeCompDemo - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name integrationtypecompdemo \
...
```bash
sam logs -n HelloWorldFunction --stack-name integrationtypecompdemo --tail
```
...
```bash
aws cloudformation delete-stack --stack-name integrationtypecompdemo
```
